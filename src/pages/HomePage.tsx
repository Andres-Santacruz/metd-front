...
import {
  ...
  lineChartOptionsCRM1,
  lineChartOptionsCRM2,
} from "../fakeApi/chartsDataFake";
import EventCalendar from "../components/Calendars/EventCalendar";
import { calendarDataCRM } from "../fakeApi/calendarDataFake";
import { revenueCRM, transactionsCRM } from "../fakeApi/generalDataFake";
import TransactionRow from "../components/Tables/TransactionRow";
          ...
          >
            ...
            >
              <CardHeader p={0}>
                <Stat>
                  ...
                  <Flex>
                    <StatNumber fontSize="md" me="4px" color={textColor}>
                      $5,927
                    </StatNumber>
                    <StatHelpText
                      color="green.400"
            ...
            >
              ...
              <Flex direction="column" height="100%">
                <Box w="100%">
                  <LineChart
                    chartData={lineChartDataCRM2 as ApexAxisChartSeries}
